const LAYOUTS = {
  grid: [
    ...
    { i: "truckWaitTimeRate", x: 4, y: 2, w: 2, h: 5, minW: 2, minH: 5 },
    { i: "waitTimeRate", x: 0, y: 2, w: 2, h: 2.5, minW: 2, minH: 2 },
    { i: "additional", x: 0, y: 0, w: 2, h: 2.5, minW: 2, minH: 2 },
  ],
  horizontal: [
    ...
    { i: "truckWaitTimeRate", x: 1, y: 4, w: 4, h: 5, minW: 2, minH: 5 },
    { i: "waitTimeRate", x: 1, y: 4, w: 4, h: 2.5, minW: 2, minH: 2 },
    { i: "additional", x: 1, y: 3, w: 4, h: 2.5, minW: 2, minH: 2 },
  ],
};
